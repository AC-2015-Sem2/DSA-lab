...
{
    int pI = getParent(parent, i), pJ = getParent(parent, j);
...
void kruskal()
{
	...
	copyOfAdjMatrix[minEdge.source][minEdge.destination] = 0;
	copyOfAdjMatrix[minEdge.destination][minEdge.source] = 0;
