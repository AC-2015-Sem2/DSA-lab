...
edgeT getEdgeAndRemoveIncidentEdges(int **adjMat, int arbN)
{
    ...
    for(i=0; i<nrOfVerteces; i++)
    {
        adjMat[minEdge.source][i] = 0;
        adjMat[i][minEdge.source] = 0;
        adjMat[minEdge.destination][i] = 0;
        adjMat[i][minEdge.destination] = 0;
    }
    return minEdge;
}
...
{
    printf("\nApproximation Algorithm's algorithm starts here: \n");
    int i;
    int counter = 0;
    ...
    printf("\nApproximation Algorithm's ended\n\n");
